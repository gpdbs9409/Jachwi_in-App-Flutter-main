          ...
          children: [
            ...
            Text(' 이메일을 '
              ...
              decoration: InputDecoration(
                ...
                hintText: '이메일', // 텍스트 필드 안에 힌트 텍스트를 설정합니다.
                contentPadding: EdgeInsets.symmetric(horizontal: deviceHeight*0.05), // 텍스트와 테두리 간의 여백을 조절합니다.
              ),),
              SizedBox( height: deviceHeight*0.03 ),
            ...
            _sendDataToBackend(email);
                  ...
                  Navigator.push(
                      context,MaterialPageRoute(builder: (context)=>getuserinform())
                  );
                },
              ),
              SizedBox( height: deviceHeight*0.03 ),
            ...
            Text('인증번호'),    SizedBox(height: 16),
              ...
              decoration: InputDecoration(
                ...
                hintText: '성함', // 텍스트 필드 안에 힌트 텍스트를 설정합니다.
